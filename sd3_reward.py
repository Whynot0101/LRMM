...
class SD3Transformer2DRewardModel(
    ...
    def __init__(
        ...
        reward_token: Optional[str] = "average",
        reward_num: int = 1,
    ):
        super().__init__()
    ...
    def forward(
        ...
        hidden_states_for_reward = None
        encoder_hidden_states_for_reward = None
